          ...
          "gold": {
            ...
            "sponsors": [
              ...
              },
              {
                ...
                "info": "<p><p>At Printify we are building the world’s largest print on demand marketplace.<br>We’re a cross-functional and highly autonomous teams with pair programming, refactoring, TDD and Continuous Delivery deeply embedded in our development process. Our HQ is based in Riga.<br><br>Want to build a highly scalable SaaS platform? Be part of professional team? Want to level up your career? <a href=\"mailto:yury+devternity@printify.com?subject=Looking for devs?\">Drop us an email</a>!</p>"
              },              
              {
        ...
        "program": [
            {
                ...
                "schedule": [
                  ...
                  },                  
                  {
                      ...
                      "description": "<h3>The course covers:</h3><ul class=\"fa-ul\"><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Introduction to AWS ideology, basic terminology and pricing</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Managing your account on AWS (shared security model, 2-factor authentication, IAM users, roles, groups and policies)</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Amazon EC2 (understanding instance types, pricing and lifecycle, storage options, AMIs)</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Configuring Amazon for High Availability and Fault Tolerance (regions and availability zones)</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Monitoring with Amazon CloudWatch</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Networking (Route53, Elastic Network Interfaces, Elastic IP, Elastic Load Balancer, Security Groups, VPC, pricing and limitations)</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Amazon EBS (use cases, limitations, snapshotting, resizing, warmup and tagging)</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Amazon RDS (database engines, snapshotting, multi-az vs. single az., read- replicas, migrating data to and from RDS)</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Amazon S3 (architecture, limitations, naming best practices, hosting static content, access policies, retention policies, reduced redundancy, infrequent access).</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Amazon Glacier (data archiving, backups, integration with S3, best practices)</li><li><span class=\"fa-li\"><i class=\"fas fa-check-square\"></i></span>Amazon CloudFront (introduction to content-delivery networks, object expiration, monitoring, signed content, access logs, SSL certificates, integration with S3)</li></ul></p><p>After this course, you'll gain <b>deep understanding of AWS</b>, learn how to operate <b>production-grade AWS infrastructure</b> and discover <b>hidden tips and tricks</b> from a certified AWS expert.</p>.</b>",
                  ...
                  },
                  {
                      ...
                      "time": "9:00",
                      "endTime": "18:00",                      
                      "tags": ["test-automation", "tdd", "bdd", "java", "spock"],                      
                      "country": "pl",
                    ...
                    },             
                   {
                      ...
                      },                                           
                    {
                        ...
                        "partner": {
                          ...
                          "img": "images/andrey_vec.png",
                          "type": "speech",                          
                          "country": "lv",
                          "twitter": "codingandrey",
                          "bio": "Co-organiser @ DevTernity, Co-founder @ <a href=\"https://dev.tube\">Dev.Tube</a>"
                        }
                      },
                    {
                        "type": "break",
