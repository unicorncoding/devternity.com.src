        ...
        "program": [
            {
                ...
                "schedule": [
                  ...
                  },
                  {
                      ...
                      "description": "<p>The strength of Kotlin is that it has drawn from wonderful features that have been teased out and tried successfully in many languages. Kotlin provides sensible syntax and semantics to create highly concise code. It is a language that just feels right in many areas.</p><p>In this hands-on workshop, which has a good balance of lecture and practice exercises, you will learn the language by working on exercises. You will start with a set of unit tests that are commented out. As you take one test at a time, you will write minimum code in Kotlin to make the tests pass. Along the way you'll learn various features of the language. The workshop walk you through the fundamentals, the advanced concepts, and how to create DSLs using Kotlin.</p><p>Bring your own laptop, and let's get you ready for writing Kotlin applications!</p>",
