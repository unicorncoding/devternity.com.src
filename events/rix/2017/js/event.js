        ...
        "program": [
            {
                ...
                "schedule": [
                  ...
                  },
                  {
                      ...
                      "description": "<p>Welcome to the 'Practical Machine Learning with Functional Programming' workshop!</p><p>This will be a hands-on workshop, so be sure to come with a laptop. You’ll also need to install F# with an editor of your choice. To get that, follow the instructions on http://fsharp.org/ for Mac, Windows or Linux. On Mac, we recommend VS Code or Xamarin Studio; on Windows, we recommend VS Code or Visual Studio.</p><p>If you’re using Atom or VS Code, follow the installation instructions in 'Getting started' on the Ionide page (http://ionide.io/). You'll need to install mono (Mac and Linux) or F# (Windows) and Atom/VS Code itself. Then install the ionide-installer package.</p><p>And that’s all, no previous experience with F# or machine learning is needed!</p>",
                  ...
                  },
                  {
                      ...
                      "description": "<p>In this hands-on workshop, together with Jakub you're gonna build a fully featured distributed system from a scratch using Spring Boot and Spring Cloud Stream. During the whole day we will learn:</p><ul><li>Why's and How's behind Event Sourcing and CQRS</li><li>How to rewrite a Domain-Driven-Design-like app to event-sourced model with pure Java (almost)</li><li>How to unit test objects backed by event sourcing</li><li>How to leverage CQRS to eliminate accidental complexity in our domain model</li><li>How to build simple Process Managers in a distributed system</li><li>How to use messaging and Spring Cloud Stream to achieve loose coupling</li><li>What are Kafka Streams and why they are awesome</li><li>...and much more!</li></ul><p>Requirements:</p><ol><li>Java 8</li><li>Maven</li><li>Your best IDE</li></ol><p>Additional Requirements (not needed, but will help):</p><ol><li>Kafka installed on your machine. It is really easy to start: https://kafka.apache.org/quickstart. Can be as docker image.</li></ol><p>Before workshop please:<p><ol><li>git clone https://gitlab.com/pilloPl/devternity-event-sourcing.git</li><li>git clone https://gitlab.com/pilloPl/devternity-event-listener.git</li><li>mvn clean install (if does not work please drop me a line at jakub.pilimon@gmail.com)</li><ol>",
            ...
            },
            {
                ...
                "schedule": [
                    ...
                    },
                    {
                        ...
                        "description": "What happens when things break? What happens when software fails? We regard it as a normal and personal inconvenience when apps crash or servers become unavailable, but what are the implications beyond the individual user? Is software reliability simply a business decision or does it have economic, social and cultural consequences? What are the moral and practical implications for software developers? And when we talk of 'systems', are we part of the 'system'? What about the bugs on our side of the keyboard? In this talk we will explore examples of failures in software and its application, and how they affect us at different scales, from user to society.",
                        "img": "images/kevlin.png",
                        "presentation": "",
                        "video": ""
                    },
                    ...
                    {
                        "time": "10:30",
                        "tags": ["career", "salary", "cv", "self-development"],
                        "name": "Yegor Bugayenko",
                        "type": "speech",
                        "twitter": "yegor256",
                        "country": "us",
                        "bio": "CEO @ Zerocracy, Author of <a href=\"https://www.amazon.com/Elegant-Objects-1-Yegor-Bugayenko/dp/1519166915\">Elegant Objects</a>, Creator of eXtremely Distributed Software Development",
                        "long_bio": "Yegor is a CEO at Zerocracy, an author of “Elegant Objects”, a regular blogger at www.yegor256.com, a proud holder of PMP and OCMEA certifications, a hands-on Java developer and a lead architect of rultor.com and takes.org, lives in Palo Alto and Kyiv.",
                        "title": "How Much Do You Cost?",
                        "description": "We all want to make more money, being programmers, senior programmers, architects. How to get more money doing the same amount of work and spending the same amount of time is always a big question. There are a number of key points, which you have to pay attention to if you want to boost your profile as a software engineer and increase your salary or your hourly rate. At the presentation we will go through all of them, illustrated by practical examples and real CVs I’ve been getting over the last five years from over 300 programmers.",
                    ...
                    },
                  {
                    ...
                    {
                        "time": "11:40",
                        "tags": ["better testing", "bdd", "clean code", "refactoring"],
                        "name": "Ian Cooper",
                        "type": "speech",
                        "twitter": "icooper",
                        "country": "gb",
                    ...
                    {
                        "time": "13:40",
                        "tags": ["unique insights", "machine learning", "f sharp"],
                        "name": "Evelina Gabasova",
                        "type": "speech",
                        "twitter": "evelgab",
                        "country": "gb",
                    ...
                    },
                   {
                    ...
                    },
                    {
                      ...
                      "description": "Tired of fancy abstractions without actual down to earth implementation? In this talk we will go through some benefits of having event-sourced model on a real example. This is full-time live coding and we will start from a simple Spring Boot based OOP application and turn it upside down with events. Basic knowledge about DDD and/or OOP is welcome!",
                      "img": "images/jakubpilo.jpg",
                      "presentation": "",
                      "video": ""
                    },
